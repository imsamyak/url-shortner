<template>
  <div class="flex-grow flex items-center justify-center p-6">
    <div class="glass-card w-full max-w-md p-8 relative overflow-hidden">
      ...
      <div
        class="absolute -top-20 -right-20 w-40 h-40 bg-brand-400 rounded-full mix-blend-multiply filter blur-3xl opacity-30">
      </div>
      <div
        class="absolute -bottom-20 -left-20 w-40 h-40 bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30">
      </div>

      <div class="relative z-10">
        <div class="text-center mb-8">
          <h2 class="text-3xl font-bold text-slate-900 mb-2">Welcome Back</h2>
          <p class="text-slate-500">Sign in to manage your URLs</p>
        </div>
        ...
        <div class="mt-6 text-center text-sm text-slate-500">
          ...
          <NuxtLink to="/register" class="text-brand-600 font-semibold hover:underline">Sign up</NuxtLink>
        </div>
      </div>
    </div>
  </div>
